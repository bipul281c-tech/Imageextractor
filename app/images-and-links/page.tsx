            ...
            <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" role="main">
                <section aria-labelledby="hero-heading">
                    <LandingHero
                        ...
                        subtitle="Extract all images and their direct links from any website. A comprehensive tool for gathering both visual assets and their source URLs in bulk."
                        onScan={handleScan}
                        isLoading={loading}
                        status={status}
                        defaultUrl="https://example.com"
                        ctaText="Extract Images & Links"
                        isQueued={isQueued}
                ...
                <section className="mt-16">
                    <div className="max-w-4xl mx-auto text-center space-y-4">
                        <h2 className="text-2xl font-semibold text-[#11224E]">The Complete Solution for Extracting Images and Links</h2>
                        <p className="text-slate-600">
                            When you need to collect images along with their exact source links, our 'Images and Links' extractor is the perfect solution.
                            We don't just find the images; we provide the full context and direct URLs for every asset discovered on a page.
                            This tool is essential for researchers, developers, and content curators who need structured data about a website's visual content.
                        </p>
                    </div>
                </section>
                ...
                <LandingFAQ
                    items={[
                        {
                            question: "Why do I need both images and links?",
                            answer: "Having both allows you to not only save the image itself but also keep a record of exactly where it's hosted. This is crucial for attribution, further development, or organizing your assets effectively."
                        },
                        {
                            question: "How many images and links can I extract?",
                            answer: "Our tool can handle hundreds of images and links per page. For larger tasks, you can use our batch mode to process multiple URLs and collect all their assets in one go."
                        },
                        {
                            question: "Does the tool extract links from CSS background images?",
                            answer: "Yes, our extraction engine is designed to find image links in `img` tags, picture elements, and within CSS styles like `background-image`."
                        }
                    ]}
                />

                <RelatedTools currentSlug="images-and-links" />
            </main>
            <Footer />
        </div>
    )
