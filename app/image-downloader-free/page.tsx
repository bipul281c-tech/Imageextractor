            ...
            <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8" role="main">
                <section aria-labelledby="hero-heading">
                    <LandingHero
                        ...
                        subtitle="Looking for an image downloader free of cost? Our tool allows you to scan any website, preview high-quality images, and download them in bulk for free."
                        onScan={handleScan}
                        isLoading={loading}
                        status={status}
                ...
                <section className="mt-16">
                    <div className="max-w-4xl mx-auto text-center space-y-4">
                        <h2 className="text-2xl font-semibold text-[#11224E]">Free Bulk Image Downloader for Any Website</h2>
                        <p className="text-slate-600">
                            Our 'Image Downloader Free' is a premium-quality tool available to everyone at no cost. It simplifies the process of getting images from the web by providing a clean, fast, and feature-rich interface.
                            You can filter images by size (minimum width) and format (JPG, PNG, WebP, etc.), ensuring you only download exactly what you need.
                            The batch mode also allows you to download images from multiple URLs simultaneously, making it a perfect tool for research and design projects.
                        </p>
                    </div>
                </section>
                    ...
                    items={[
                        {
                            ...
                            answer: "Yes, 'Image Downloader Free' is completely free to use. There are no hidden costs, no trial periods, and no premium features locked behind paywalls."
                        },
                        {
                            question: "Do I need to create an account used the downloader?",
                            answer: "No registration is required. You can start downloading images from any website immediately without providing an email address or creating an account."
                        },
                        {
                            question: "Can I download images in high quality?",
                            answer: "Our tool extracts images in their original quality from the source website. You can use our size filter to specifically find high-resolution images."
                        },
                        {
                            question: "Are there any limits on bulk downloads?",
                            answer: "You can download all the images found on a page in a single ZIP file. There are no daily limits on how many times you can use the tool."
                        }
                    ]}
                />

                <RelatedTools currentSlug="image-downloader-free" />
            </main>
            <Footer />
        </div>
    )
